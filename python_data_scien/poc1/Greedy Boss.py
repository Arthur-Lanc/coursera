...
def greedy_boss(days_in_simulation, bribe_cost_increment, plot_type = STANDARD):
    ...
    if plot_type == STANDARD:
        days_vs_earnings.append((current_day,current_balance+cost_on_bribe))
    elif plot_type == LOGLOG:
        days_vs_earnings.append((math.log(current_day),math.log(current_balance+cost_on_bribe)))

    #######################################################################
    # while current_day <= days_in_simulation:
    #     current_balance += current_salary
    #     while current_balance >= current_bribe_cost:
    #         current_balance -= current_bribe_cost
    #         cost_on_bribe += current_bribe_cost
