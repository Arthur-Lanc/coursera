...
//		text("Below 4.0", 75, 225);
		...
		textAlign(LEFT, CENTER);
		text("Size ~ Magnitude", 50-5, 185);
		
		
		
		radius = 10;
		fill(255,255,0);
		ellipse(x, 205, radius, radius);
		fill(0,0,255);
		ellipse(x, 225, radius, radius);
		fill(255,0,0);
		ellipse(x, 245, radius, radius);
		fill(255,255,255);
		ellipse(x, 265, radius, radius);
		int lineLen = 7;
		y = 265;
		line(x-lineLen, y-lineLen, x+lineLen, y+lineLen);
		line(x-lineLen, y+lineLen, x+lineLen, y-lineLen);
		
		fill(0, 0, 0);
		text("Shallow", 75, 205);
		text("Intermedia", 75, 225);
		text("Deep", 75, 245);
		text("Past Day", 75, 265);
...
//		HashMap<String,Integer> countryNumQuakeMap = new HashMap<String,Integer>();
...
/*		for(Marker m : quakeMarkers) {
			EarthquakeMarker em = (EarthquakeMarker)m;
			System.out.println("age: "+(String) em.getProperty("age"));
		}*/
